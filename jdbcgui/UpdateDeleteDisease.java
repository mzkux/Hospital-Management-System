 ...
 * @author 
 */
public class UpdateDeleteDisease extends javax.swing.JFrame {

    myDBCon dbCon;
    ResultSet rs;
    ResultSet rsdeptno;

    public UpdateDeleteDisease() {
        initComponents();
        ...
        lblErrorSeverity.setVisible(false);
        dbCon = new myDBCon();
        getNewData();
    }
    ...
    private void getNewData() {
        ...
        try {
            // populate fields
            rs = dbCon.executeStatement("SELECT id, name, severity FROM disease ORDER BY id ASC ");
    ...
    private void initComponents() {
        ...
        lblErrorSeverity = new javax.swing.JLabel();
        ...
        jLabel1.setText("Update/Delete Disease");
        ...
        lblErrorSeverity.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        lblErrorSeverity.setForeground(new java.awt.Color(255, 0, 0));
        lblErrorSeverity.setText("error label");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtSeverity, javax.swing.GroupLayout.Alignment.LEADING))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblErrorSeverity, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(36, 36, 36)
    ...
    private void populateFields() {
        try {
            ...
            txtSeverity.setText(rs.getString("severity"));

            EnableDisableButtons();
        } catch (SQLException ex) {
            Logger.getLogger(UpdateDeleteDisease.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
   ...
   private void MovePrevious() {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            String prepSQL = "DELETE disease WHERE id = '" + txtId.getText().trim() + "'";
            System.out.println("[DELETE Disease] " + prepSQL);
            ...
            if (result > 0) {
                javax.swing.JLabel label = new javax.swing.JLabel("Disease of Id " + txtId.getText().trim() + " deleted successfully.");
                label.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 18));
                JOptionPane.showMessageDialog(null, label, "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
                getNewData();
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Error deleting disease.");
        }
    ...
    boolean isValidData() {
        ...
        if (field_severity.isEmpty()) {
            lblErrorSeverity.setText("Cannot be empty");
            lblErrorSeverity.setVisible(true);
            result = false;
        }
        
        if (field_severity.length() > 15) {
            lblErrorSeverity.setText("Cannot exceed 15 chars");
            lblErrorSeverity.setVisible(true);
            result = false;
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            if (isValidData()) {
                ...
                String prepSQL = "UPDATE disease SET name = " + 
                        "'" + field_name + 
                        "', severity = '" + field_severity + 
                        "' WHERE id = " + field_id;
                
                System.out.println("[UPDATE Severity] " + prepSQL);
            
                // confirmation dialog
                if (JOptionPane.showConfirmDialog(null, "Are you sure you want to update this disease?") != 0) {
                ...
                int result = dbCon.executePrepared(prepSQL);
                if (result > 0) {
                    javax.swing.JLabel label = new javax.swing.JLabel("Disease of Id " + txtId.getText() + " updated successfully.");
                    label.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 18));
                    JOptionPane.showMessageDialog(null, label, "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "Error updating disease." + e.getMessage());
    ...
    private javax.swing.JLabel lblErrorSeverity;
